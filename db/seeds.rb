User.create!(email: 'admin@fakebook.com', password: 'password', firstname: "Best", lastname: "Admin")
User.create!(email: 'chef@fakebook.com', password: 'password', firstname: "Best", lastname: "Chef")
User.create!(email: 'sage@fakebook.com', password: 'password', firstname: "Clairvoyant", lastname: "Sage")
